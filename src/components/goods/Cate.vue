	...
	<div>
		...
		<el-card>
			...
			<tree-table :columns="columns" :data="catelist" :expand-type="false" :selection-type="false"
				:show-row-hover="false" border class="treeTable" show-index>
				<!--是否有效-->
			...
			<el-pagination :current-page="queryInfo.pagenum" :page-size="queryInfo.pagesize"
				:page-sizes="[3, 5, 10, 15]" :total="total" layout="total, sizes, prev, pager, next, jumper"
			...
			<el-form ref="addCateFormRef" :model="addCateForm" :rules="addCateFormRules" label-width="100px">
				...
				<el-form-item label="父级分类:">
					...
					<el-cascader v-model="selectedKeys" :options="parentCateList" :props="cascaderProps"
						expand-trigger="hover" @change="parentCateChanged" clearable change-on-select></el-cascader>
				</el-form-item>
			</el-form>
