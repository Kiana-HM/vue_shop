  ...
  <div>
    ...
    <el-card>
      ...
      <el-table :data='userlist' border stripe>
        ...
        <el-table-column label='操作' width='180px'>
          <template slot-scope='scope'>
            ...
            <!-- 分配角色按钮 -->
            <el-tooltip :enterable='false' content='Top Center 分配角色' effect='dark' placement='top'>
      ...
      <el-pagination :current-page='queryInfo.pagenum' :page-size='queryInfo.pagesize'
                     :page-sizes='[1, 2, 5, 10]' :total='total' layout='total, sizes, prev, pager, next, jumper'
      ...
      <!--修改用户的对话框-->
      <el-dialog :visible.sync='editDialogVisible' title='修改用户' width='50%' @close='editDialogClosed'>
